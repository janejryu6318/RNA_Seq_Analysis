...
Metadata_Cortex <- subset(Metadata, condition %in% c("BC_HS", "BC_LS"))
Metadata_Cortex



#   Rename the Metadata
rownames(Metadata_Cortex) <- c("SS_HS_2570",
                               "SS_HS_2571",
                               "SS_HS_2573",
                               "SS_LS_2561",
                               "SS_LS_2562",
...
#   Eliminate SS_LS_2555
Metadata_Cortex <- subset(Metadata_Cortex, row.names(Metadata_Cortex) != "SS_LS_2555")
Metadata_Cortex
...
Counts_Cortex <- dplyr::select(Counts, c("X.singular_genomics.P1549.STAR_bam.P1549_10_SS_HS_2570_S10_L001Aligned.sortedByCoord.out.bam",
                                         "X.singular_genomics.P1549.STAR_bam.P1549_11_SS_HS_2571_S11_L001Aligned.sortedByCoord.out.bam",
                                         "X.singular_genomics.P1549.STAR_bam.P1549_12_SS_HS_2573_S12_L001Aligned.sortedByCoord.out.bam",
                                         "X.singular_genomics.P1549.STAR_bam.P1549_13_SS_LS_2561_S13_L001Aligned.sortedByCoord.out.bam",
                                         "X.singular_genomics.P1549.STAR_bam.P1549_14_SS_LS_2562_S14_L001Aligned.sortedByCoord.out.bam",
                                         "X.singular_genomics.P1549.STAR_bam.P1549_15_SS_LS_2554_S15_L001Aligned.sortedByCoord.out.bam",
                                         "X.singular_genomics.P1549.STAR_bam.P1549_16_SS_LS_2555_S16_L001Aligned.sortedByCoord.out.bam",
                                         "X.singular_genomics.P1549.STAR_bam.P1549_17_SS_LS_2575_S17_L001Aligned.sortedByCoord.out.bam",
                                         "X.singular_genomics.P1549.STAR_bam.P1549_9_SS_HS_2569_S9_L001Aligned.sortedByCoord.out.bam"))
str(Counts_Cortex)
...
#   Eliminate SS_LS_2555
Counts_Cortex <- Counts_Cortex[, -7]
head(Counts_Cortex)

write.csv(Counts_Cortex, file = "CORTEX_HS vs LS/LS_#2555_Eliminated/Raw Data_Cortex_STAR Counts.csv")
...
Dataset$Condition <- relevel(Dataset$condition, ref = "BC_LS")
DEG <- DESeq(Dataset)
Result <- results(DEG)
summary(Result)
...
write.csv(Result.df, "CORTEX_HS vs LS/LS_#2555_Eliminated/DEG Result_HS vs LS.csv")
...
write.csv(Best_FoldChange, "CORTEX_HS vs LS/LS_#2555_Eliminated/FOLDCHANGE/Best Genes with largest FoldChange_Cortex_SS_LS vs HS.csv")
write.csv(Best_Pvalue, "CORTEX_HS vs LS/LS_#2555_Eliminated/PVALUE/Best Genes with lowest Pvalue_Cortex_SS_LS vs HS.csv")





url <- read.table("https://davidbioinformatics.nih.gov/data/download/conv_FDF71A5A464C1737578358738.txt",
                  header = TRUE,
                  sep = "\t",
                  quote = "\"")

colnames(url) = c("Symbol", "ENSEMBL", "Species", "Description")
str(url)
head(url)
...
merged_data <- merge(ENSEMBL_col, url, by = "ENSEMBL")
str(merged_data)


write.csv(merged_data, "CORTEX_HS vs LS/LS_#2555_Eliminated/FINAL_FOLDCHANGE_Hippocampus_SS_LS vs HS.csv")
